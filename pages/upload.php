...
<body>
    <div class="upload-container">
        ...
        <div class="input-container">
            <div class="title-box">
                <input type="text" name="title" id="title" placeholder="Share a captivating title..." required
                    title="Enter the Title of your Blog">
            </div>
            <div class="caption-part">
                <textarea name="caption" id="caption" cols="30" rows="10"
                    placeholder="What's on your mind? Share your thoughts here..." required
                    title="What do you want to talk about?"></textarea>
            </div>
